      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#020617]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
            <a href="#free-guide" className="hover:text-white transition-colors">무상수거 안내</a>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="text-center mb-24">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="w-full sm:w-auto bg-white text-black hover:bg-slate-200 px-8 py-4 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:auto-rows-[180px]">
            ...
            <div className="md:col-span-2 md:row-span-2 bento-card flex flex-col justify-between group overflow-hidden">
              <div className="z-10">
              ...
              <button className="z-10 mt-4 flex items-center gap-2 text-sm font-bold text-green-500 hover:gap-3 transition-all">
            ...
            {/* Community Highlight */}
            <div id="community" className="md:col-span-1 md:row-span-1 bento-card flex flex-col justify-center">
